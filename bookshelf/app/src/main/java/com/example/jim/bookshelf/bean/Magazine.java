        ...
        implements Serializable
{
    ...
    public Article getArticle(int paramInt)
    {
    ...
    {
        return MagazineDbService.getInstence(paramContext).getMagazineStatus(this.downloadTask.getUrl());
    }
    ...
    public void setArticleList(List<Article> paramList)
    {
