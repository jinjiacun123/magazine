...
public class SlideTabs3 extends FragmentActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.test_fragment_slidetabs3);
        ...
        mBtnTabs[1].setTextColor(getResources().getColorStateList(R.color.black));
        ...
        mBtnTabs[2].setTextColor(getResources().getColorStateList(R.color.red_btn_bg_color));
